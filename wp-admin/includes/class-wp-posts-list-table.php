...
<?php
		if ( 'top' === $which && !is_singular() ) {
			 ...
			 */
			do_action( 'restrict_manage_posts','khoa-hoc-lap-trinh','classname','lọc theo tên lớp', $this->screen->post_type );
			
			
			do_action( 'restrict_manage_posts','tuyen-dung-viec-lam','jobname','lọc theo tên công việc', $this->screen->post_type );

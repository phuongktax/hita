...
<div id="content">
    <div id="container_full">
        <div class="ts-promotional-banner2 parallax-section">
            <div class="container">
                <h3><?php the_title();?></h3>
                <a href="<?php echo get_bloginfo('url') ?>/" title="Quay về trang chủ"><span> <i class="fa fa-home"></i></span> Trang chủ </a><span> <i class="fa fa-angle-right"></i> </span><a href="<?php echo get_bloginfo('url') ?>/doi-ngu" title="Đội ngũ nhân sự"> Đội ngũ</a> <i class="fa fa-angle-right"></i> <?php the_title();?>
                <hr>
            	<div class="row">
            	    <div class="col-sm-12"> 
            	        <div class="ts-promotional-banner2-main parallax-section">
            	            ...
            	            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
                               ...
                               <div class="col-sm-12 col-md-6 col-lg-6">
                                    <article>
                                       <span><i class="fa fa-briefcase"></i></span> Chức vụ: <?php echo get_field( 'role');?><br> 

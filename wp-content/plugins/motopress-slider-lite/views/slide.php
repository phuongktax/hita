...
<?php
    ...
    echo '<button type="button" class="button-primary mpsl-button" id="save_slide">' . __($saveTitle, 'motopress-slider-lite') . '</button>';
    ...
    if ($sliderType === 'custom') {
        ...
        echo '<a class="button-secondary mpsl-button" href="' . $slideEditUrlNext . '">' . __('&rarr; Next Slide', 'motopress-slider-lite') . '</a>';

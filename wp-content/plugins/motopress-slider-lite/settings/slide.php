    ...
    'video' => array(
        ...
        'options' => array(
            ...
            'bg_video_src_mp4' => array(
                'type' => 'text',
                'default' => '',
                'label' => __('Video Source MP4: ', 'motopress-slider-lite'),
//                'dependency' => array(
//                    'parameter' => 'bg_types',
//                    'value' => 'video'
//                )
            ...
            'bg_video_src_webm' => array(
                'type' => 'text',
                'default' => '',
                'label' => __('Video Source WEBM: ', 'motopress-slider-lite'),
//                'dependency' => array(
//                    'parameter' => 'bg_types',
//                    'value' => 'video'
//                )
            ...
            'bg_video_src_ogg' => array(
                'type' => 'text',
                'default' => '',
                'label' => __('Video Source OGG: ', 'motopress-slider-lite'),
//                'dependency' => array(
//                    'parameter' => 'bg_types',
//                    'value' => 'video'
//                )
            ...
            'bg_video_loop' => array(
                'type' => 'checkbox',
                'default' => false,
                'label' => __('Loop Video: ', 'motopress-slider-lite'),
//                'dependency' => array(
//                    'parameter' => 'bg_types',
//                    'value' => 'video'
//                )
...
//                )
            ...
            'bg_video_fillmode' => array(
                'type' => 'select',
                'default' => 'fill',
                'label' => __('Video Fillmode: ', 'motopress-slider-lite'),
                'list' => array(
...
//                )
            ...
            'bg_video_cover' => array(
                'type' => 'checkbox',
                'default' => false,
                'label' => __('Video Cover', 'motopress-slider-lite'),
//                'dependency' => array(
//                    'parameter' => 'bg_types',
//                    'value' => 'video'
//                )
            ...
            'bg_video_cover_type' => array(
                'type' => 'select',
                'default' => '',
                'label' => __('Video Cover Type', 'motopress-slider-lite'),
                'list' => array(
    ...
    'link' => array(
        ...
        'options' => array(
            'link' => array(
                'type' => 'text',
                'label' => __('Link this slide', 'motopress-slider-lite'),
                'default' => ''
            ),
            'link_target' => array(
                'type' => 'checkbox',
    ...
    'misc' => array(
        ...
        'options' => array(
            'slide_classes' => array(
                'type' => 'text',
                'label' => __('Class name:', 'motopress-slider-lite'),
                'default' => '',
            ),
            'slide_id' => array(
                'type' => 'text',
                'label' => __('CSS id:', 'motopress-slider-lite'),
                'default' => '',
            )
        )
    ),
